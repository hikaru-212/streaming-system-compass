"""Guarded future PR5 PostgreSQL composition; importing performs no database I/O.
...
from experiments.load_capacity_protection.pr5_model import RetryPlan, prepare_workload
from experiments.load_capacity_protection.pr5_runner import PreparedRuntime
