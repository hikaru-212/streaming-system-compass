...
PostgreSQL-backed integration tests currently assume migrations 001–007,
including the role baseline, repaired projection-progress schema, and
foundational DecisionReceipt schema, have been applied to the test database:
...
Foundational PR6 tests additionally depend on the typed `decision_receipts`
schema and its explicit initial grants; they do not imply runtime receipt
materialization.
