...
- [Load / Capacity Protection](./load_capacity_protection/README.md) — separately owned investigation; PR0 research / boundary documentation complete; PR1 characterization method active.
